...
export function TaxBarChart({ rawData, title }) {
    ...
    const xAxisHeight = longestLabelLength * 5 + 40;
    ...
    return (
        <div className='flex flex-col items-end'>
            <button
                ...
                className="text-sm bg-primaryAccent text-white px-3 py-1 rounded hover:bg-blue-600 cursor-pointer"
            >
                Download Chart
            </button>
