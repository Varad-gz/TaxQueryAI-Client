    ...
    return (
        <div className='w-full h-[80px] px-[20px] md:px-[40px] flex justify-between items-center'>
            ...
            <div className='text-md md:text-lg'>
                <Link href='/signin'><button className='border-[2px] rounded-lg px-2.5 py-1.5 font-bold cursor-pointer hover:bg-black hover:text-white transition ease-in-out delay-75'>Sign in</button></Link>
            </div>
        </div>
    )
}
